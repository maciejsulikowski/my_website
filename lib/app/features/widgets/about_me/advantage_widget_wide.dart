...
class AdvantageWidgetWide extends StatefulWidget {
  const AdvantageWidgetWide({
    required this.text,
  ...
  @override
  State<AdvantageWidgetWide> createState() => _AdvantageWidgetWideState();
}

class _AdvantageWidgetWideState extends State<AdvantageWidgetWide> {
  bool isHovered = true;
