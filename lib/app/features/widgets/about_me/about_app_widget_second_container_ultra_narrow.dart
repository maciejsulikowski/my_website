...
class AboutAppSecondWidgetContainerUltraNarrow extends StatefulWidget {
  const AboutAppSecondWidgetContainerUltraNarrow({
    super.key,
  });

  @override
  State<AboutAppSecondWidgetContainerUltraNarrow> createState() =>
      _AboutAppSecondWidgetContainerNarroUltrawState();
}

class _AboutAppSecondWidgetContainerNarroUltrawState
    extends State<AboutAppSecondWidgetContainerUltraNarrow>
