...
class ContactWidgetNarrow extends StatefulWidget {
  const ContactWidgetNarrow({
    super.key,
  });

  @override
  State<ContactWidgetNarrow> createState() => _ContactWidgetNarrowState();
}
...
class _ContactWidgetNarrowState extends State<ContactWidgetNarrow>
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        VisibilityDetector(
          key: const Key('contactWidgetNarrow'),
