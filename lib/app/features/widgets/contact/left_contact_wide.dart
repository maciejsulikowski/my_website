...
class LeftContactWidgetWide extends StatefulWidget {
  const LeftContactWidgetWide({
    super.key,
  });

  @override
  State<LeftContactWidgetWide> createState() => _LeftContactWidgetWideState();
}

class _LeftContactWidgetWideState extends State<LeftContactWidgetWide>
